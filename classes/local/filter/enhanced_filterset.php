...
class enhanced_filterset extends filterset {
     ...
     */
    public function add_filter_definition(string $fieldname, object $filterdefinition): void {
     ...
     * @param string $alias sql fragment or column name
     * @return void
     */
    public function set_alias(string $columnname, string $alias): void {
     ...
     * @param array|null $forcedaliases
     * @return array
     */
    public function get_sql_for_filter(?string $tableprefix = null, ?array $excludedfiltersname = null,
            ?array $forcedaliases = null): array {
