 ...
 */
namespace local_cltools\crud; // https://docs.moodle.org/dev/Coding_style#Namespaces_within_.2A.2A.2Ftests_directories.
defined('MOODLE_INTERNAL') || die();
use local_cltools\crud\helper as crud_helper;
global $CFG;
...
class local_cltools_crud_helper_testcase extends \advanced_testcase {
    ...
    public function test_get_crud_default() {
        $crudmgmt = crud_helper\base::create(\local_cltools\sample\simple\entity::class);
