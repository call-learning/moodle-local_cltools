...
Feature: As a user I want to be able to add/edit/view and list entities defined as "Simple entity"
  ...
  Scenario: I can list entities
    ...
    And the following "local_cltools > entities" exist:
      | entitynamespace | shortname   | idnumber           | description | path  | sortorder | scaleid | image                                       |
      | simple          | Shortname 1 | IdnumberShortname1 | Shortname1  | 1234  | 1         | scale1  | local/cltools/tests/fixtures/files/icon.png |
      | simple          | Shortname 2 | IdnumberShortname2 | Shortname2  | 12345 | 1         | scale1  | local/cltools/tests/fixtures/files/icon.png |
